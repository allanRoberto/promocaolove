...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/promocaolove.git" 
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/promocaolove" 
...
set :local_domain, 'promocaolove.art.com.br'
